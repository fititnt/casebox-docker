...
mysql -u root -e "CREATE DATABASE cb__casebox; CREATE USER 'casebox'@'localhost' IDENTIFIED BY 'StrongPassword'; GRANT ALL PRIVILEGES ON cb__casebox.* TO 'casebox'@'localhost'; FLUSH PRIVILEGES;"
...
mysql -u root cb__casebox < "/var/www/casebox/$CASEBOX_DATABSE_SEED1"

echo "/tools/init-database.sh: importing /var/www/casebox/$CASEBOX_DATABSE_SEED2"
mysql -u root cb__casebox < "/var/www/casebox/$CASEBOX_DATABSE_SEED2"
